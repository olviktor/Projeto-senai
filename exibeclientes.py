...
class Vizualizacliente:
    def __init__(self, user_id):
        ...
        self.janela8.title("LISTA DE CLIENTES DISPONIVEIS")
        self.janela8.config(bg='#ff8c00')
        self.treeview = ttk.Treeview(
            self.janela8, columns=("Id", "Nome", "Telefone"), show="headings", height=900
        )
        ...
        scrollbar = ttk.Scrollbar(self.janela8)
        ...
        self.informacoes_frame = tk.Frame(self.janela8, bg='#7ac0d7')
    ...
    def pesquisa(self, event):
        ...
        for clientes in clientes:
            self.treeview.insert(
                "", "end", values=(clientes[0], clientes[1], clientes[2], clientes[3])
            )
    def ChamaPerfil(self):
        ...
        print("chama perfil  user_id{}".format(self.user_id))